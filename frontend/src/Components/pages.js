...
export function IndustryInfo() {
    return (
        <div className="container col-xs-12 col-sm-10 col-md-8 col-lg-7" style={{ marginTop: "40px", textAlign: "left" }}>
